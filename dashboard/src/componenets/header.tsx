    ...
    <header className="bg-gray-800">
      <nav className="container mx-auto px-6 py-3 md:flex md:justify-between md:items-center">
        <div className="flex items-center justify-between">
          <div>
            <a className="flex items-center text-xl font-bold text-white hover:text-gray-300" href="#">
              <span className="mr-2">
                <FaTasks />
              </span>
              Task Manager
        ...
        <div className="md:flex md:items-center md:mx-6">
          <div className="flex flex-col md:flex-row md:mx-6">
            <a className="my-1 text-sm text-gray-400 hover:text-gray-100 md:mx-4 md:my-0" href="#">
              <span className="mr-2">
                <FaNewspaper />
              </span>
              News
